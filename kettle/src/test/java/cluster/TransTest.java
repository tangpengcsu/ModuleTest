...
public class TransTest {
    ...
    @Test
    public void testdbf2db() throws KettleException {
 /*               TransMeta transMeta1 = new TransMeta("L:\\ETL\\ceshi\\1.ktr");
        Trans trans1 = new Trans(transMeta1);*/
          transMeta = new TransMeta( "transFile.ktr", "myTrans" );
 ...
 /*       PostgreSQLDatabaseMeta postgreSQLDatabaseMeta = new PostgreSQLDatabaseMeta();
        ...
        loadDBF.setDbfFileName("D:\\users\\tangp\\Documents\\大数据分析平台\\kettle\\SJSJG.DBF");
