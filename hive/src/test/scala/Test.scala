...
/** 版权声明：本程序模块属于大数据分析平台（KDBI）的一部分
  ...
  * ----------------------------------------------------------------
  */
case class Person1(NAME: String, ADDR: String)
object Test  {
 ...
 def test(): Unit = {
   ...
   val sqlServer = "jdbc:sqlserver://192.168.50.98:1433;DatabaseName=bi_config"
